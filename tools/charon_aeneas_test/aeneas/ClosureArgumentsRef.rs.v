...
(** [rem_cli::fun_name]:
    Source: '/home/matt/rem-matt/rem-cli/tools/charon_aeneas_test/rust/closure_arguments_ref.rs', lines 7:0-9:1 *)
Definition fun_name (v : array i32 3%usize) (factor : i32) : result unit :=
  admit
.

(** [rem_cli::parent]:
    Source: '/home/matt/rem-matt/rem-cli/tools/charon_aeneas_test/rust/closure_arguments_ref.rs', lines 1:0-5:1 *)
Definition parent (factor : i32) : result unit :=
  fun_name (mk_array 3%usize [ 1%i32; 2%i32; 3%i32 ]) factor
.

(** [rem_cli::main]:
    Source: '/home/matt/rem-matt/rem-cli/tools/charon_aeneas_test/rust/closure_arguments_ref.rs', lines 11:0-13:1 *)
